...
save( OS_ONS_dt_combi , file = "../Outputs/WIP_crossSectional/OS_ONS_dt_combi_37M385807.RData")
```
...
AB_summary_output <- setNames(AB_summary_output,
 ...
 write.csv(totals_AB_summary_output ,  '../Outputs/OS_data_coverage_summary_by_AdminArea.csv' )

...
combi_SC_dt[ , n_bIoDDecil_income_grp := cut(n_bIoDDecil_income,
                            breaks = c(0, 3, 7, Inf),
...
#Make barriers deprivation groups
combi_SC_dt[ , n_iIoDDecil_IDACI_grp := cut(n_iIoDDecil_IDACI,
                            breaks = c(0, 3, 7, Inf),
...
imd_jOlderPerson <-  income_imd2019lsoa_E[ `Indices of Deprivation` == "j. Income Deprivation Affecting Older People Index (IDAOPI)",]
imd_jOlderPerson <-dcast(imd_jOlderPerson, lsoa11cd ~ Measurement, value.var = c("Value"))
combi_SC_dt[imd_jOlderPerson,  on = 'lsoa11cd', c('n_jIoDRank_IDAOPI','n_jIoDDecil_IDAOPI') := .(Rank,Decile)]
#Make barriers deprivation groups
combi_SC_dt[ , n_jIoDDecil_IDAOPI_grp := cut(n_jIoDDecil_IDAOPI,
                            breaks = c(0, 3, 7, Inf),
                            include.lowest= TRUE, labels=c('Deprived_Older_1-3','Average.O.Income_4-7','UnDeprived_Older_8-10'))]
```

...
tmp[,CURRENT_ENERGY_EFFICIENCY := type.convert(CURRENT_ENERGY_EFFICIENCY) ]##magically convert to str to int:
tmp[, n_d_cEE := CURRENT_ENERGY_EFFICIENCY - shift(CURRENT_ENERGY_EFFICIENCY , fill = first(CURRENT_ENERGY_EFFICIENCY)), by=list(n_GRP)]
tmp[, n_d_cEE := ifelse(INSPECTION_DATE == n_first, NA_integer_, n_d_cEE), by=list(n_GRP)]
